...
class H5Splitter:
    ...
    def get_traces_division(self):
        ...
        seismic_train_ids = rng.choice(source_ids, seis_divs[0])
        source_ids = list(set(source_ids)-set(seismic_train_ids))

        # Se eligen los ids de val y se quitan de la lista
        seismic_val_ids = rng.choice(source_ids, seis_divs[1])
        ...
        nonseismic_train_ids = rng.choice(source_ids, seis_divs[0])
        source_ids = list(set(source_ids) - set(nonseismic_train_ids))

        # Se eligen los ids de val y se quitan de la lista
        nonseismic_val_ids = rng.choice(source_ids, seis_divs[1])
