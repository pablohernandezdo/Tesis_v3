...
class Comp:
    ...
    def save_histogram(self):
        ...
        plt.subplot(2, 1, 1)
        plt.hist(self.df1[self.df1['label'] == 1]['out'], 100, alpha=0.5)
        plt.hist(self.df1[self.df1['label'] == 0]['out'], 100, alpha=0.5)
        ...
        plt.grid(True)
        plt.subplot(2, 1, 2)
        plt.hist(self.df2[self.df2['label'] == 1]['out'], 100, alpha=0.5)
        plt.hist(self.df2[self.df2['label'] == 0]['out'], 100, alpha=0.5)
